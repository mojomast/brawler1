export const stages = [
  {
    ...
    props: [{ kind: 'amp', x: 350 }, { kind: 'pyramid', x: 740 }, { kind: 'sign', x: 1130, text: 'HOT DOG PYRAMID ROCK' }, { kind: 'curtain', x: 1640 }, { kind: 'amp', x: 1940 }],
    encounters: [
  ...
  },
  {
    ...
    props: [{ kind: 'barricade', x: 420 }, { kind: 'sign', x: 900, text: 'ARTIST WRISTBANDS?' }, { kind: 'tent', x: 1420 }, { kind: 'barricade', x: 1900 }, { kind: 'pyramid', x: 2360 }],
    encounters: [
  ...
  },
  {
    ...
    props: [{ kind: 'screen', x: 420, text: 'SKIP RATE' }, { kind: 'screen', x: 980, text: '+0.004%' }, { kind: 'pyramid', x: 1460 }, { kind: 'screen', x: 1960, text: 'CONTENT' }, { kind: 'curtain', x: 2380 }],
    encounters: [
  ...
  },
  {
    ...
    props: [{ kind: 'curtain', x: 360 }, { kind: 'sign', x: 820, text: 'NO ENCORE CLAUSE' }, { kind: 'amp', x: 1320 }, { kind: 'pyramid', x: 1860 }, { kind: 'sign', x: 2340, text: 'PALATABILITY' }],
    encounters: [
